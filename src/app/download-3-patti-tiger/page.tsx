...
export const metadata: Metadata = {
  ...
  description: 'Download 3 Patti Tiger APK free for Android. Play Teen Patti, Rummy, Dragon Tiger & more. Earn real cash with JazzCash & EasyPaisa. Latest version V1.230 - 49MB.',
  keywords: [
    'Download 3 Patti Tiger',
    '3 Patti Tiger APK download',
    '3 Patti Tiger Android',
    'Teen Patti download',
    'Free card game APK',
  ...
  alternates: {
    canonical: "https://3pattitigergame.com.pk/download-3-patti-tiger",
  },
  openGraph: {
    title: 'Download 3 Patti Tiger Game Free APK For Android',
    description: 'Download 3 Patti Tiger APK free. Play Teen Patti, Rummy & more. Earn real cash with secure payments. 500K+ downloads!',
    url: "https://3pattitigergame.com.pk/download-3-patti-tiger",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Download 3 Patti Tiger APK",
      }
    ],
  },
  twitter: {
...
export default function DownloadPage() {
  ...
  const schemaData = {
    ...
    "description": "Download 3 Patti Tiger APK free for Android. Play Teen Patti, Rummy, Dragon Tiger & more. Earn real cash with JazzCash & EasyPaisa.",
    "screenshot": [
      ...
      <section className="py-8 md:py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            ...
            <span className="text-[#FFA500]">3 Patti Tiger Game</span>
          ...
          <p className="text-lg text-gray-300 leading-relaxed max-w-4xl mx-auto">
            <Link href="/" className="text-accent hover:underline font-semibold">3 Patti Tiger</Link> is a hub of top popular casino games like cards, poker, Rummy, Crash, Dragon Tiger, and much more. You can download this game free of cost.
          </p>
        </div>
      ...
      <section className="py-12 px-4 md:px-8 max-w-7xl mx-auto" id="download-steps">
        <div className="bg-secondary rounded-xl p-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-[#FFA500] text-center">
            Process to Download & Install 3 Patti Tiger
          </h2>
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-[#0A1029] rounded-lg p-6 border-l-4 border-[#FFA500]">
              ...
              <p className="text-gray-300 leading-relaxed">
                Click on download button to get 3 Patti Tiger Game APK. Wait for automatic download completion.
              </p>
            </div>
            ...
            <div className="bg-[#0A1029] rounded-lg p-6 border-l-4 border-[#f97316]">
              ...
              <p className="text-gray-300 leading-relaxed">
                Finally, 3 Patti Tiger is successfully installed on your device, open it and start your journey with your first deposit in this earning app and grab opportunity to earn a lot of money.
              </p>
            </div>
          </div>
        </div>
